...
extern double ipsec_naive_inactivity_timeout;
...
extern double& ipsec_naive_inactivity_timeout [[deprecated("Remove in v4.1. Use zeek::detail::ipsec_naive_inactivity_timeout.")]];
