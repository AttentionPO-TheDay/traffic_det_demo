...
double ipsec_naive_inactivity_timeout;
...
void init_net_var()
	...
	ipsec_naive_inactivity_timeout = id::find_val("ipsec_naive_inactivity_timeout")->AsInterval();
...
double& ipsec_naive_inactivity_timeout = zeek::detail::ipsec_naive_inactivity_timeout;
